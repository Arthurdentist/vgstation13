...
/mob/proc/rightandwrong(var/summon_type) //0 = Summon Guns, 1 = Summon Magic
	...
	for(var/mob/living/carbon/human/H in player_list)
		...
		var/randomizemagic = pick("fireball","smoke","blind","mindswap","forcewall","knock","horsemask","charge",/*"wandnothing", "wanddeath", "wandresurrection", "wandpolymorph", "wandteleport", "wanddoor", "wandfireball", "staffchange", "staffhealing" None of this is finished*/
								"armor", "scrying", "clowncurse", "mimecurse", "shoesnatch", "subjugate", "robesummon")
		if(!summon_type)
